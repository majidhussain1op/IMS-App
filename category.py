...
class categoryClass:
    ...
    #===========Employee Details==========
     ...
     self.category_table=ttk.Treeview(cat_frame,columns=("Category ID", "name"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
     ...
     self.category_table.column("Category ID",width=90)
     self.category_table.column("name", width=110)
     self.category_table.pack(fill=BOTH,expand=1)
     self.category_table.bind("<ButtonRelease-1>",self.get_data)
     
     #==========Images===========
     self.im1=Image.open("Images/img-inventory.png")
