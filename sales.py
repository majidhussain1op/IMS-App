...
class salesClass:
    def __init__(self,root):
     ...
     #=================Title===========
     lbl_title=Label(self.root,text="View Customer Bill", font=("goudy old style",30),bg="#1a459d",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=10)
    ...
    #==========Bill Area===========
     ...
     #Image=========
     self.bill_photo=Image.open("Images/cat.jpg")
