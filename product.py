...
class productClass:
    ...
    #==========columns:2=========
     ...
     txt_name=Entry(product_Frame,textvariable=self.var_name, font=("goudy old style", 15),bg="light yellow").place(x=150,y=160,width=200)
     txt_price=Entry(product_Frame,textvariable=self.var_price, font=("goudy old style", 15),bg="light yellow").place(x=150,y=210,width=200)
     txt_qty=Entry(product_Frame,textvariable=self.var_qty, font=("goudy old style", 15),bg="light yellow").place(x=150,y=260,width=200)
    ...
    #========Buttons==========
     btn_search=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15), bg="#2196c3", fg="white",cursor="hand2").place(x=10,y=400,width=100,height="40")
     btn_update=Button(product_Frame,text="Update",command=self.Update,font=("goudy old style",15), bg="#4caf55", fg="white",cursor="hand2").place(x=120,y=400,width=100,height="40")
     btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15), bg="#f44339", fg="white",cursor="hand2").place(x=230,y=400,width=100,height="40")
     btn_clear=Button(product_Frame,text="Clear",command=self.clear,font=("goudy old style",15), bg="#607d9f", fg="white",cursor="hand2").place(x=340,y=400,width=100,height="40")
